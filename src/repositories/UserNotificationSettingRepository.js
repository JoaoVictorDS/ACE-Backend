...
/**
 * Repositório de UserNotificationSetting
 * Gerencia todas as operações de configuração de notificações dos usuários
 * Estende BaseRepository para herdar métodos comuns
 */
class UserNotificationSettingRepository extends BaseRepository {
    /**
     * Construtor
     * Define o model como 'userNotificationSetting' para usar nas queries
     */
    constructor() {
