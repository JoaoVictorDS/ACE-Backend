...
const { createWorkspaceSchema, showWorkspaceSchema, updateWorkspaceSchema, deleteWorkspaceSchema, movedWorkspaceSchema, getHistorySchema } = require('./workspace.validator')
...
router.get('/:workspace_id', authMiddleware, validationMiddleware(showWorkspaceSchema), WorkspaceController.show)
