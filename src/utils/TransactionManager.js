...
class TransactionManager {
    ...
    /**
     * Executa uma transação com logging e tratamento de erro centralizado
     */
    ...
    /**
     * Executa com retry automático em caso de deadlock
     * Útil para operações de reordenamento concorrente (exatamente o seu caso de `move`)
     */
